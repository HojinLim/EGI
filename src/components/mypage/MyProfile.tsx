        ...
        <S.MypageWrapper>
          <S.MypageWrap>
            <S.ProfileTable>
              <S.ProfileBox>
                ...
                <S.ProfileInfo>
                  {isEditing ? (
                    ...
                    <S.NickName>
                      {jotaiUserData ? jotaiUserData.nickname : ""}
                    </S.NickName>
                  )}
                  ...
                  {isEditing ? (
                    <div>
                      ...
                      <S.EditBtn onClick={handleEditClickClose}>
                        취소하기
                      </S.EditBtn>
                    </div>
                  ) : (
                    <S.EditBtn onClick={handleEditClickOpen}>
                      프로필 수정
                    </S.EditBtn>
                  )}
                </S.ProfileInfo>
              ...
              <S.EditProfile>
                {isEditing ? (
                  <div>
                    <div>
                      <S.EditProfileLabel htmlFor="file-input">
                        파일선택
                      </S.EditProfileLabel>
                      <S.EditProfileInput
                        id="file-input"
            ...
            <div>
              <S.EtcInfoBox>
                <S.GradeBox>
                  <S.GradeFc>{grade()}</S.GradeFc>{" "}
                  <S.GradeText>회원 등급</S.GradeText>
                </S.GradeBox>
                <S.CompleteBox>
